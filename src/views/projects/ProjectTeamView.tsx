    ...
    if (data) return (
        <>
            ...
            <nav className="my-5 flex gap-3">
                <button
                    type="button"
                    className="bg-purple-400 hover:bg-purple-500 px-4 py-1 text-white text-xl font-bold cursor-pointer transition-colors"
                    onClick={() => navigate(location.pathname + `?addMember=true`)}
                >
                    Agregar Colaborador
                </button>
                <Link to={`/projects/${projectId}`} className="bg-fuchsia-600 hover:bg-fuchsia-700 px-4 py-1 text-white text-xl font-bold cursor-pointer transition-colors">
                    Volver a proyecto
                </Link>
            </nav>
