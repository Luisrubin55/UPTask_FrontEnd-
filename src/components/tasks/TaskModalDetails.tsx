                            ...
                            >
                                <Dialog.Panel className="w-full max-w-3xl transform overflow-hidden rounded-2xl bg-white text-left align-middle shadow-xl transition-all p-14">
                                    ...
                                    {data.completedBy.length ? (
                                        <>
                                            <p className='font-bold text-2xl text-slate-600 my-3 '>Historial de Cambios </p>
                                            <ul className='list-decimal'>
                                                {data.completedBy.map(activityLog => (
                                                    <li key={activityLog._id}><span className='font-bold text-slate-600'>{statusTranslations[activityLog.status]}</span>{' '} por: {activityLog.user.name}</li>
                                                ))}
                                            </ul>
                                        </>
                                    ) : null}
